...
Authentication/identity service. **Phase 1 state:** a bootable **gRPC microservice** exposing
`HealthService.Check` over its **own** Postgres database. Auth domain logic (login, JWT issuance,
