...
// Phase 1 (spec 003): brands boots as a gRPC microservice exposing HealthService.Check.
// loadBrandsConfig() runs FIRST — the process refuses to start (non-zero exit) on any
